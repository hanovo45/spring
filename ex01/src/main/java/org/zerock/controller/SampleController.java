...
public class SampleController {
	...
	public String basic() {
		// sample/page1 호출. 해당메소드를 실행
		log.info("basic...");
		return "page1";	// /WEB-INF/views + .jsp					
	}
	
	@RequestMapping("page2")
	public void basic2() {
		log.info("basic2...");
		// 반환값이 없는데 page2.jsp가 열림
		// /sample/page2 => /WEB-INF/views/sample/page2.jsp																								
	}
	
	@RequestMapping("myInfo")
	public String basic3() {
		return "sample/myInfo";		// /sample/myInfo =>
	}
